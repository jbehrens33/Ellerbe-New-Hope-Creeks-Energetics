...
## 1. Request Parameters  
    ...
    Name: ECGS_NHC_try2_3-10-2023  

    Date Completed:** 2023-03-10T17:28:10.903758  

    ID: 56fd704a-9177-45b9-81b0-ea44cde663c1  
    ...
    Details:  
        ...
        Coordinates:  
            ...
            EllerbeClub, 36.0194, -78.8948  
            EllerbeGlenn, 36.0593, -78.8325  
            NHC, 35.9795, -79.0018  
    
    Version: This request was processed by AppEEARS version 3.26  

## 2. Request File Listing  

- Comma-separated values file with data extracted for a specific product
  - ECGS-NHC-try2-3-10-2023-MCD15A3H-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - ECGS-NHC-try2-3-10-2023-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - ECGS-NHC-try2-3-10-2023-request.json
- xml file
  - ECGS-NHC-try2-3-10-2023-MCD15A3H-061-metadata.xml  
...
- Myneni, R., Knyazikhin, Y., Park, T. (2021). MODIS/Terra+Aqua Leaf Area Index/FPAR 4-Day L4 Global 500m SIN Grid V061. NASA EOSDIS Land Processes DAAC. Accessed 2023-03-10 from https://doi.org/10.5067/MODIS/MCD15A3H.061. Accessed March 10, 2023.

## 9. Software Citation  

AppEEARS Team. (2023). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.26. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed March 10, 2023. https://appeears.earthdatacloud.nasa.gov
